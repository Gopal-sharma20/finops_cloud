...
export default function CFODashboard() {
  // Get connected providers from onboarding - initialize immediately
  ...
  const costTrendData = useMemo(() => {
    ...
    // Add historical data (sum only connected providers) - don't require forecast data
    ...
    // Add forecast data (sum only connected providers) - optional, don't fail if missing
    ...
    console.log('Cost trend data:', {
      ...
      connectedProviders: { isAwsConnected, isAzureConnected, isGcpConnected }
    })

    return combined
  }, [costTrendsData, forecastData, isAwsConnected, isAzureConnected, isGcpConnected, timeRange])

  const isLoading = azureLoading || awsLoading || gcpLoading || trendsLoading || forecastLoading
